...
public class Lemmatizer {
    ...
    private String[] noLemmaEN = new String[]{"access","accumbens", "addresses", "afterwards", "always", "approaches", "analytics", "analyses", "bayes", "biases", "businesses","charles", "classes", "cowles", "crises","discusses", "economics", "ethics", "focuses", "forbes", "fries", "goes", "humanities", "hypotheses", "james", "inches", "keynes", "koopmans", "lies", "losses", "nhs", "physics", "politics", "processes", "ries", "saas", "series", "sometimes", "species", "status", "themselves", "united states", "neural processes", "humanities", "witnesses"};

    private String[] noLemmaFR = new String[]{"ects", "cours", "sens","puis","temps","parcours","près","auprès","outils","travers","pays","concours","êtes","divers","éthos","ethos","alors","corps","ouvrirons","univers","sans"};
    ...
    public Lemmatizer(String lang, boolean local) {
        ...
        noLemmaSet.addAll((Set<String>)Stopwords.getStopWords(lang, local).getLeft());
        this.lang = lang;
    }
