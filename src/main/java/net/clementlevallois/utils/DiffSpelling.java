...
//     * @return
//     */
//    public String diff_text1Custom(LinkedList<Diff> diffs) {
//        StringBuilder text = new StringBuilder();
//        for (Diff aDiff : diffs) {
//            if (aDiff.operation == Operation.DELETE) {
//                if (aDiff.text.matches(" *")) {
//                    text.append("<span STYLE=\"color: #E01B1B\"><u>").append(aDiff.text).append("  </span></u>");
//                } else {
//                    text.append("<span STYLE=\"color: #E01B1B\">").append(aDiff.text).append("</span>");
//
//                }
//            }
...
//     * @return
//     */
//    public String diff_text2Custom(LinkedList<Diff> diffs) {
//        StringBuilder text = new StringBuilder();
//        for (Diff aDiff : diffs) {
//
//            if (aDiff.operation == Operation.INSERT) {
